...
if (!function_exists('focusable_get_template_part')) {
    function focusable_get_template_part($slug, $name = null, $args = [])
    {
        ...
        $template = focusable_locate_template($templates, false);
...
function focusable_locate_template($template_names, $load = false, $require_once = true, $args = array())
{
    $located = '';
